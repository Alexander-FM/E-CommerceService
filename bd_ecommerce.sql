...
INSERT INTO `categoria` (`id`, `nombre`, `vigencia`, `foto_id`)
VALUES (1, 'Tallarines', b'1', 4),
       (2, 'Arroz', b'1', 7),
       (3, 'Postres', b'1', 10);
...
INSERT INTO `cliente` (`id`, `departamento`, `direccion_envio`, `distrito`, `nombres`, `num_doc`, `provincia`, `tipo_doc`, `foto_id`,
                       `apellido_materno`, `apellido_paterno`, `telefono`)
VALUES (1, 'Lambayeque', 'Urb. Villa los sauces mz.v lt.5', 'Chiclayo', 'Oscar Antonio', '73139193', 'Chiclayo', 'DNI', 2, 'Veintimilla',
        'Cumpa', '963258753'),
       (2, 'Lambayeque', 'Calle sucre 903', 'Ferreñafe', 'Alexander', '78019778', 'Ferreñafe', 'DNI', 1, 'Medina', 'Fuentes', '917967148'),
       (5, 'Lambayeque', 'Calle Nicanor Carmona N° 256', 'Ferreñafe', 'Ximena', '45896325', 'Ferreñafe', 'DNI', 9, 'Samamé', 'Quezada',
        '987456321'),
       (6, 'Lambayeque', 'Calle Sucre 903', 'Ferreñafe', 'Jorge Luis', '56987412', 'Ferreñafe', 'DNI', 11, 'Medina', 'Fuentes',
        '987596321');
...
INSERT INTO `detalle_pedido` (`id`, `cantidad`, `precio`, `pedido_id`, `platillo_id`)
VALUES (1, 2, 10, 1, 2),
       (2, 2, 30, 1, 3);
...
INSERT INTO `documento_almacenado` (`id`, `eliminado`, `estado`, `extension`, `file_name`, `nombre`)
VALUES (1, b'0', 'A', '.jpg', 'fd89f1da-6594-4276-8cef-05766982e97f', 'Alexander'),
...
INSERT INTO `pedido` (`id`, `anular_pedido`, `fecha_compra`, `monto`, `cliente_id`)
VALUES (1, b'0', '2021-08-14 23:34:01', 80, 1);
...
INSERT INTO `platillo` (`id`, `descripcion_platillo`, `nombre`, `precio`, `stock`, `vigencia`, `categoria_id`, `foto_id`, `recomendado`)
VALUES (1,
        ...
        'Arroz con Pollo', 15.5, 20, b'1', 2, 3, b'1'),
       (2,
        'Los Tallarines rojos con pollo es un plato de fondo que se come mucho en el Perú. Este plato es una fusión de la comida peruana e italiana, ya que se origina en el spaghetti ala bolognese.',
        'Tallarines Rojos', 10, 18, b'1', 1, 6, b'0'),
       (3,
        'Una de las comidas de la costar que suele acompañar los platos de carne, se tratan de unos tallarines a base de leche evaporada, espinaca, nueces pecanas, albahaca y parmesano. Todos estos ingredientes forman la característica salsa verde.',
        'Tallarines Verdes', 30, 18, b'1', 1, 5, b'1'),
       (4,
...
INSERT INTO `usuario` (`id`, `clave`, `email`, `vigencia`, `cliente_id`)
VALUES (1, 'admin123', 'oantonio@gmail.com', b'1', 1),
